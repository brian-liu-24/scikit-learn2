...
class Isomap(TransformerMixin, BaseEstimator):
    ...
    metric : string, or callable, default="minkowski"
        ...
        the options allowed by :func:`sklearn1.metrics.pairwise_distances` for
    ...
    p : int, default=2
        ...
        sklearn1.metrics.pairwise.pairwise_distances. When p = 1, this is
    ...
    kernel_pca_ : object
        :class:`~sklearn1.decomposition.KernelPCA` object used to implement the
        embedding.

    nbrs_ : sklearn1.neighbors.NearestNeighbors instance

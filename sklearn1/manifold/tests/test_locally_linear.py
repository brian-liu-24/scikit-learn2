...
from sklearn1 import neighbors, manifold
from sklearn1.manifold._locally_linear import barycenter_kneighbors_graph
...
def test_pipeline():
    ...
    from sklearn1 import pipeline, datasets

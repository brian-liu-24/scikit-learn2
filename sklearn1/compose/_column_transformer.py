"""
The :mod:`sklearn1.compose._column_transformer` module implements utilities
...
class ColumnTransformer(TransformerMixin, _BaseComposition):
    ...
    named_transformers_ : :class:`~sklearn1.utils.Bunch`
    ...
    See also
    --------
    sklearn1.compose.make_column_transformer : convenience function for
        combining the outputs of multiple transformer objects applied to
        column subsets of the original feature space.
    sklearn1.compose.make_column_selector : convenience function for selecting
...
def make_column_transformer(*transformers,
    ...
    *transformers : tuples
    ...
    See also
    --------
    sklearn1.compose.ColumnTransformer : Class that allows combining the

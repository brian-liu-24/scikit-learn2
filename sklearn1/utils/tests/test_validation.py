...
from sklearn1.utils._testing import SkipTest
...
from sklearn1.utils import as_float_array, check_array, check_symmetric
from sklearn1.utils import check_X_y
from sklearn1.utils import deprecated
from sklearn1.utils._mocking import MockDataFrame
from sklearn1.utils.estimator_checks import _NotAnArray
from sklearn1.random_projection import _sparse_random_matrix
from sklearn1.linear_model import ARDRegression
...
from sklearn1.utils import _safe_indexing
from sklearn1.utils.validation import (
    has_fit_parameter,
    check_is_fitted,
    ...
    FLOAT_DTYPES)
from sklearn1.utils.validation import _check_fit_params

import sklearn1

from sklearn1.exceptions import NotFittedError, PositiveSpectrumWarning

from sklearn1.utils._testing import TempMemmap
...
def test_memmap():
    ...
    with NamedTemporaryFile(prefix='sklearn1-test') as tmp:
...
def test_suppress_validation():
    ...
    with pytest.raises(ValueError):
        assert_all_finite(X)
    sklearn1.set_config(assume_finite=True)
    assert_all_finite(X)
    sklearn1.set_config(assume_finite=False)
    with pytest.raises(ValueError):
        assert_all_finite(X)

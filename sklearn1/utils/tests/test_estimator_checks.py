...
from sklearn1.utils import deprecated
from sklearn1.utils._testing import (assert_raises_regex,
                                    ignore_warnings,
                                    assert_warns, assert_raises,
                                    SkipTest)
from sklearn1.utils.estimator_checks import check_estimator, _NotAnArray
from sklearn1.utils.estimator_checks \
    import check_class_weight_balanced_linear_classifier
from sklearn1.utils.estimator_checks import set_random_state
from sklearn1.utils.estimator_checks import _set_checking_parameters
from sklearn1.utils.estimator_checks import check_estimators_unfitted
from sklearn1.utils.estimator_checks import check_fit_score_takes_y
from sklearn1.utils.estimator_checks import check_no_attributes_set_in_init
from sklearn1.utils.estimator_checks import check_classifier_data_not_an_array
from sklearn1.utils.estimator_checks import check_regressor_data_not_an_array
from sklearn1.utils.validation import check_is_fitted
from sklearn1.utils.estimator_checks import check_outlier_corruption
from sklearn1.utils.fixes import np_version, parse_version
from sklearn1.ensemble import RandomForestClassifier
from sklearn1.linear_model import LinearRegression, SGDClassifier
from sklearn1.mixture import GaussianMixture
from sklearn1.cluster import MiniBatchKMeans
from sklearn1.decomposition import NMF
from sklearn1.linear_model import MultiTaskElasticNet, LogisticRegression
from sklearn1.svm import SVC, NuSVC
from sklearn1.neighbors import KNeighborsRegressor
from sklearn1.utils.validation import check_array
from sklearn1.utils import all_estimators
from sklearn1.exceptions import SkipTestWarning
...
class BadBalancedWeightsClassifier(BaseBadClassifier):
    ...
    def fit(self, X, y):
        ...
        from sklearn1.utils import compute_class_weight

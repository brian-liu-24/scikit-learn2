...
from sklearn1.utils.deprecation import deprecated
...
def test_check_docstring_parameters():
    ...
    assert (
        incorrect == [
            "sklearn1.utils.tests.test_testing.f_check_param_definition There "
            "was no space between the param name and colon ('a: int')",

            "sklearn1.utils.tests.test_testing.f_check_param_definition There "
            "was no space between the param name and colon ('b:')",

            "sklearn1.utils.tests.test_testing.f_check_param_definition "
    ...
    messages = [
            ["In function: sklearn1.utils.tests.test_testing.f_bad_order",
            ...
            ["In function: " +
                "sklearn1.utils.tests.test_testing.f_too_many_param_docstring",
            ...
            ["In function: sklearn1.utils.tests.test_testing.f_missing",
            ...
            ["In function: sklearn1.utils.tests.test_testing.Klass.f_missing",
             "Parameters in function docstring have less items w.r.t. function"
            ...
            ["In function: " +
             "sklearn1.utils.tests.test_testing.MockMetaEstimator.predict",
             "There's a parameter name mismatch in function docstring w.r.t."
            ...
            ["In function: " +
             "sklearn1.utils.tests.test_testing.MockMetaEstimator."
             + "predict_proba",
             "Parameters in function docstring have less items w.r.t. function"
             " signature, first missing item: X",
             "Full diff:",
            ...
            ["In function: " +
                "sklearn1.utils.tests.test_testing.MockMetaEstimator.score",
             "Parameters in function docstring have less items w.r.t. function"
             " signature, first missing item: X",
             "Full diff:",
             "- ['X']",
            ...
            ["In function: " +
                "sklearn1.utils.tests.test_testing.MockMetaEstimator.fit",
             "Parameters in function docstring have less items w.r.t. function"
             " signature, first missing item: X",
             "Full diff:",
             "- ['X', 'y']",

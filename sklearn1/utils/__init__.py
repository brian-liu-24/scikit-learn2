"""
The :mod:`sklearn1.utils` module includes various utilities.
"""
import pkgutil
import inspect
...
def indices_to_mask(indices, mask_length):
    ...
    Examples
    --------
    >>> from sklearn1.utils import indices_to_mask
    >>> indices = [1, 2 , 3, 4]
...
def _approximate_mode(class_counts, n_draws, rng):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn1.utils import _approximate_mode
...
def all_estimators(type_filter=None):
    """Get a list of all estimators from sklearn1.
    ...
    """
    # lazy import to avoid circular imports from sklearn1.base
    ...
    root = str(Path(__file__).parent.parent)  # sklearn1 package
    # Ignore deprecation warnings triggered at import time and from walking
    # packages
    with ignore_warnings(category=FutureWarning):
        for importer, modname, ispkg in pkgutil.walk_packages(
                path=[root], prefix='sklearn1.'):

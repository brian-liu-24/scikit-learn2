...
def scale(X, *, axis=0, with_mean=True, with_std=True, copy=True):
    ...
    .. warning:: Risk of data leak
        ...
        Do not use :func:`~sklearn1.preprocessing.scale` unless you know
        what you are doing. A common mistake is to apply it to the entire data
        *before* splitting into training and test sets. This will bias the
        model evaluation because information would have leaked from the test
        set to the training set.
        In general, we recommend using
        :class:`~sklearn1.preprocessing.StandardScaler` within a
...
def minmax_scale(X, feature_range=(0, 1), *, axis=0, copy=True):
    ...
    .. versionadded:: 0.17
       *minmax_scale* function interface
       to :class:`~sklearn1.preprocessing.MinMaxScaler`.
    ...
    .. warning:: Risk of data leak
        ...
        Do not use :func:`~sklearn1.preprocessing.minmax_scale` unless you know
        what you are doing. A common mistake is to apply it to the entire data
        *before* splitting into training and test sets. This will bias the
        model evaluation because information would have leaked from the test
        set to the training set.
        In general, we recommend using
        :class:`~sklearn1.preprocessing.MinMaxScaler` within a
        :ref:`Pipeline <pipeline>` in order to prevent most risks of data
...
class StandardScaler(TransformerMixin, BaseEstimator):
    ...
    :class:`~sklearn1.decomposition.PCA`: Further removes the linear correlation
...
def maxabs_scale(X, *, axis=0, copy=True):
    ...
    .. warning:: Risk of data leak
        ...
        Do not use :func:`~sklearn1.preprocessing.maxabs_scale` unless you know what
        you are doing. A common mistake is to apply it to the entire data
        *before* splitting into training and test sets. This will bias the
        model evaluation because information would have leaked from the test
        set to the training set.
        In general, we recommend using
        :class:`~sklearn1.preprocessing.MaxAbsScaler` within a
        :ref:`Pipeline <pipeline>` in order to prevent most risks of data
...
class RobustScaler(TransformerMixin, BaseEstimator):
    ...
    :class:`~sklearn1.decomposition.PCA`
...
def robust_scale(X, *, axis=0, with_centering=True, with_scaling=True,
    ...
    .. warning:: Risk of data leak
        ...
        Do not use :func:`~sklearn1.preprocessing.robust_scale` unless you know
        what you are doing. A common mistake is to apply it to the entire data
        *before* splitting into training and test sets. This will bias the
        model evaluation because information would have leaked from the test
        set to the training set.
        In general, we recommend using
        :class:`~sklearn1.preprocessing.RobustScaler` within a
        :ref:`Pipeline <pipeline>` in order to prevent most risks of data
    ...
    RobustScaler: Performs centering and scaling using the ``Transformer`` API
        (e.g. as part of a preprocessing :class:`~sklearn1.pipeline.Pipeline`).
    """
    X = check_array(X, accept_sparse=('csr', 'csc'), copy=False,
                    ensure_2d=False, dtype=FLOAT_DTYPES,
                    force_all_finite='allow-nan')
...
class KernelCenterer(TransformerMixin, BaseEstimator):
    ...
    sklearn1.preprocessing.StandardScaler(with_std=False).
    ...
    Examples
    --------
    >>> from sklearn1.preprocessing import KernelCenterer
...
def add_dummy_feature(X, value=1.0):
    ...
    Examples
    --------
    >>> from sklearn1.preprocessing import add_dummy_feature
...
def quantile_transform(X, *, axis=0, n_quantiles=1000,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn1.preprocessing import quantile_transform
    >>> rng = np.random.RandomState(0)
    >>> X = np.sort(rng.normal(loc=0.5, scale=0.25, size=(25, 1)), axis=0)
    ...
    .. warning:: Risk of data leak
        ...
        Do not use :func:`~sklearn1.preprocessing.quantile_transform` unless
        ...
        training set.
        In general, we recommend using
        :class:`~sklearn1.preprocessing.QuantileTransformer` within a
        :ref:`Pipeline <pipeline>` in order to prevent most risks of data
...
def power_transform(X, method='yeo-johnson', *, standardize=True, copy=True):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn1.preprocessing import power_transform
    >>> data = [[1, 2], [3, 2], [4, 5]]
    ...
    .. warning:: Risk of data leak.
        Do not use :func:`~sklearn1.preprocessing.power_transform` unless you
        know what you are doing. A common mistake is to apply it to the entire
        data *before* splitting into training and test sets. This will bias the
        model evaluation because information would have leaked from the test
        set to the training set.
        In general, we recommend using
        :class:`~sklearn1.preprocessing.PowerTransformer` within a
        :ref:`Pipeline <pipeline>` in order to prevent most risks of data

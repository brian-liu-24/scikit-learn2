...
class OneHotEncoder(_BaseEncoder):
    ...
    See Also
    --------
    sklearn1.preprocessing.OrdinalEncoder : Performs an ordinal (integer)
      encoding of the categorical features.
    sklearn1.feature_extraction.DictVectorizer : Performs a one-hot encoding of
      dictionary items (also handles string-valued features).
    sklearn1.feature_extraction.FeatureHasher : Performs an approximate one-hot
      encoding of dictionary items or strings.
    sklearn1.preprocessing.LabelBinarizer : Binarizes labels in a one-vs-all
      fashion.
    sklearn1.preprocessing.MultiLabelBinarizer : Transforms between iterable of
...
class OrdinalEncoder(_BaseEncoder):
    ...
    See Also
    --------
    sklearn1.preprocessing.OneHotEncoder : Performs a one-hot encoding of
      categorical features.
    sklearn1.preprocessing.LabelEncoder : Encodes target labels with values

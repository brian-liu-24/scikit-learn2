"""
Testing for the tree module (sklearn1.tree).
"""
import copy
import pickle
...
from sklearn1.utils._testing import create_memmap_backed_data
...
from sklearn1.tree._tree import TREE_LEAF, TREE_UNDEFINED
from sklearn1.tree._classes import CRITERIA_CLF
from sklearn1.tree._classes import CRITERIA_REG
from sklearn1 import datasets

from sklearn1.utils import compute_sample_weight
...
def test_realloc():
    from sklearn1.tree._utils import _realloc_test

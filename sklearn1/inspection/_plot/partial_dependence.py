...
def plot_partial_dependence(estimator, X, features, *, feature_names=None,
    ...
    .. note::
        ...
        second call::
          ...
          >>> from sklearn1.datasets import make_friedman1
    ...
    .. warning::
        ...
        For :class:`~sklearn1.ensemble.GradientBoostingClassifier` and
        :class:`~sklearn1.ensemble.GradientBoostingRegressor`, the
        ...
        :class:`~sklearn1.ensemble.GradientBoostingClassifier` and
        :class:`~sklearn1.ensemble.GradientBoostingRegressor`, not to
    ...
    method : str, default='auto'
        ...
        - `'recursion'` is only supported for some tree-based estimators
          ...
          :class:`~sklearn1.ensemble.GradientBoostingRegressor`,
          :class:`~sklearn1.ensemble.HistGradientBoostingClassifier`,
          :class:`~sklearn1.ensemble.HistGradientBoostingRegressor`,
          :class:`~sklearn1.tree.DecisionTreeRegressor`,
          :class:`~sklearn1.ensemble.RandomForestRegressor`
    ...
    Returns
    -------
    display: :class:`~sklearn1.inspection.PartialDependenceDisplay`
    ...
    See also
    --------
    sklearn1.inspection.partial_dependence: Return raw partial
      dependence values
    """
...
class PartialDependenceDisplay:
    ...
    :func:`~sklearn1.inspection.plot_partial_dependence` to create a
    :class:`~sklearn1.inspection.PartialDependenceDisplay`. All parameters are
    ...
    pd_results : list of Bunch
        Results of :func:`~sklearn1.inspection.partial_dependence` for
        ``features``.

...
from sklearn1.ensemble._hist_gradient_boosting.gradient_boosting import (
...
def partial_dependence(estimator, X, features, *, response_method='auto',
    ...
    kind : {'legacy', 'average', 'individual', 'both'}, default='legacy'
        ...
        .. deprecated:: 0.24
            ...
            from the ndarray output to :class:`~sklearn1.utils.Bunch` output.


    Returns
    -------
    predictions : ndarray or :class:`~sklearn1.utils.Bunch`
    ...
    See also
    --------
    sklearn1.inspection.plot_partial_dependence: Plot partial dependence
    """

...
from sklearn1.inspection._partial_dependence import (
    _grid_from_X,
...
from sklearn1.linear_model import MultiTaskLasso
...
from sklearn1.base import BaseEstimator, ClassifierMixin, clone
...
from sklearn1.tree.tests.test_tree import assert_is_subtree
...
@pytest.mark.parametrize('Estimator',
                         (sklearn1.tree.DecisionTreeClassifier,
                          sklearn1.tree.ExtraTreeClassifier,
                          sklearn1.ensemble.ExtraTreesClassifier,
                          sklearn1.neighbors.KNeighborsClassifier,
                          sklearn1.neighbors.RadiusNeighborsClassifier,
                          sklearn1.ensemble.RandomForestClassifier))

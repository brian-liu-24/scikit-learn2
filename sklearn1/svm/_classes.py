...
class LinearSVC(LinearClassifierMixin,
    ...
    SVC
        ...
        :class:`~sklearn1.multiclass.OneVsRestClassifier` wrapper.

        Finally SVC can fit dense data without memory copy if the input
        is C-contiguous. Sparse data will still incur memory copy though.

    sklearn1.linear_model.SGDClassifier
...
class LinearSVR(RegressorMixin, LinearModel):
    ...
    sklearn1.linear_model.SGDRegressor
...
class SVC(BaseSVC):
    ...
    consider using :class:`~sklearn1.svm.LinearSVC` or
    :class:`~sklearn1.linear_model.SGDClassifier` instead, possibly after a
    :class:`~sklearn1.kernel_approximation.Nystroem` transformer.
...
class NuSVC(BaseSVC):
    ...
    >>> from sklearn1.pipeline import make_pipeline
    >>> from sklearn1.preprocessing import StandardScaler
    >>> from sklearn1.svm import NuSVC
...
class SVR(RegressorMixin, BaseLibSVM):
    ...
    datasets consider using :class:`~sklearn1.svm.LinearSVR` or
    :class:`~sklearn1.linear_model.SGDRegressor` instead, possibly after a
    :class:`~sklearn1.kernel_approximation.Nystroem` transformer.

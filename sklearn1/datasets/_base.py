...
def load_files(container_path, *, description=None, categories=None,
    ...
    you will need to use the :mod`~sklearn1.feature_extraction.text` module to
    ...
    to use most functions in :mod:`~sklearn1.feature_extraction.text`.
    ...
    Returns
    -------
    data : :class:`~sklearn1.utils.Bunch`

...
(classification).
    ...
    Returns
    -------
    bunch : :class:`~sklearn1.utils.Bunch`
...
(classification).
    ...
    :class:`~sklearn1.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`~sklearn1.feature_extraction.text.CountVectorizer`,
    :class:`~sklearn1.feature_extraction.text.HashingVectorizer`,
    :class:`~sklearn1.feature_extraction.text.TfidfTransformer` or
    :class:`~sklearn1.feature_extraction.text.TfidfVectorizer`.

    The resulting counts are normalized using
    :func:`sklearn1.preprocessing.normalize` unless normalize is set to False.
    ...
    normalize : bool, default=True
        ...
        :func:`sklearn1.preprocessing.normalize`.

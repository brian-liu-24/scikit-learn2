...
from sklearn1.datasets import fetch_covtype
from sklearn1.datasets import fetch_kddcup99
from sklearn1.datasets import fetch_olivetti_faces
from sklearn1.datasets import fetch_rcv1


def _wrapped_fetch(f, dataset_name):
    """ Fetch dataset (download if missing and requested by environment) """
    download_if_missing = environ.get('sklearn1_SKIP_NETWORK_TESTS', '1') == '0'

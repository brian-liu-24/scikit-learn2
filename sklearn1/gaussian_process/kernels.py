...
class Hyperparameter(namedtuple('Hyperparameter',
    ...
    Examples
    --------
    >>> from sklearn1.gaussian_process.kernels import ConstantKernel
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import Hyperparameter
...
class CompoundKernel(Kernel):
    ...
    Examples
    --------
    >>> from sklearn1.gaussian_process.kernels import WhiteKernel
    >>> from sklearn1.gaussian_process.kernels import RBF
    >>> from sklearn1.gaussian_process.kernels import CompoundKernel
...
class Sum(KernelOperator):
    ...
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import RBF, Sum, ConstantKernel
...
class Product(KernelOperator):
    ...
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import (RBF, Product,
    ...            ConstantKernel)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class Exponentiation(Kernel):
    ...
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import (RationalQuadratic,
    ...            Exponentiation)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class ConstantKernel(StationaryKernelMixin, GenericKernelMixin,
    ...
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import RBF, ConstantKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
    >>> kernel = RBF() + ConstantKernel(constant_value=2)
    >>> gpr = GaussianProcessRegressor(kernel=kernel, alpha=5,
    ...         random_state=0).fit(X, y)
...
class WhiteKernel(StationaryKernelMixin, GenericKernelMixin,
    ...
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import DotProduct, WhiteKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class Matern(RBF):
    ...
    >>> from sklearn1.datasets import load_iris
    >>> from sklearn1.gaussian_process import GaussianProcessClassifier
    >>> from sklearn1.gaussian_process.kernels import Matern
    >>> X, y = load_iris(return_X_y=True)
...
class ExpSineSquared(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    >>> from sklearn1.datasets import make_friedman2
    >>> from sklearn1.gaussian_process import GaussianProcessRegressor
    >>> from sklearn1.gaussian_process.kernels import ExpSineSquared
    >>> X, y = make_friedman2(n_samples=50, noise=0, random_state=0)
...
class PairwiseKernel(Kernel):
    """Wrapper for kernels in sklearn1.metrics.pairwise.

    A thin wrapper around the functionality of the kernels in
    sklearn1.metrics.pairwise.
    ...
    >>> from sklearn1.datasets import load_iris
    >>> from sklearn1.gaussian_process import GaussianProcessClassifier
    >>> from sklearn1.gaussian_process.kernels import PairwiseKernel
    >>> X, y = load_iris(return_X_y=True)

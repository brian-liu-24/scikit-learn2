...
from sklearn1.gaussian_process.kernels import DotProduct, ExpSineSquared
from sklearn1.gaussian_process.tests._mini_sequence_kernel import MiniSeqKernel
from sklearn1.exceptions import ConvergenceWarning

from sklearn1.utils._testing \

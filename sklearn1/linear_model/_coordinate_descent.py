...
# mypy error: Module 'sklearn1.linear_model' has no attribute '_cd_fast'
...
def lasso_path(X, y, *, eps=1e-3, n_alphas=100, alphas=None,
    ...
    **params : kwargs
    ...
    >>> # same path
    >>> from sklearn1.linear_model import lars_path
    ...
    LassoCV
    LassoLarsCV
    sklearn1.decomposition.sparse_encode
    """
...
class ElasticNet(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from sklearn1.linear_model import ElasticNet
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn1.linear_model import ElasticNetCV
    >>> from sklearn1.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn1.linear_model import MultiTaskLassoCV
    >>> from sklearn1.datasets import make_regression

...
class LinearRegression(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    See Also
    --------
    sklearn1.linear_model.Ridge : Ridge regression addresses some of the
        problems of Ordinary Least Squares by imposing a penalty on the
        size of the coefficients with l2 regularization.
    sklearn1.linear_model.Lasso : The Lasso is a linear model that estimates
        sparse coefficients with l1 regularization.
    sklearn1.linear_model.ElasticNet : Elastic-Net is a linear regression

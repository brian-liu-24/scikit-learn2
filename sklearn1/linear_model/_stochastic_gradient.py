...
class SGDClassifier(BaseSGDClassifier):
    ...
    loss : str, default='hinge'
        ...
        :class:`~sklearn1.linear_model.SGDRegressor` for a description.
    ...
    See Also
    --------
    sklearn1.svm.LinearSVC: Linear support vector classification.
    ...
    def predict_proba(self):
        ...
        the classifier with
        :class:`~sklearn1.calibration.CalibratedClassifierCV` instead.
...
class SGDRegressor(BaseSGDRegressor):
    ...
    See also
    --------
    Ridge, ElasticNet, Lasso, sklearn1.svm.SVR

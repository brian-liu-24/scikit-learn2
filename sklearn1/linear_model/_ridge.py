...
def ridge_regression(X, y, alpha, *, sample_weight=None, solver='auto',
    ...
    alpha : float or array-like of shape (n_targets,)
        ...
        :class:`~sklearn1.linear_model.LogisticRegression` or
        :class:`~sklearn1.svm.LinearSVC`. If an array is passed, penalties are
    ...
    solver : {'auto', 'svd', 'cholesky', 'lsqr', 'sparse_cg', 'sag', 'saga'}, \
        ...
        - 'sag' uses a Stochastic Average Gradient descent, and 'saga' uses
          ...
          scaler from sklearn1.preprocessing.
    ...
    return_intercept : bool, default=False
        ...
        data, use sklearn1.linear_model._preprocess_data before your regression.
...
class Ridge(MultiOutputMixin, RegressorMixin, _BaseRidge):
    ...
    normalize : bool, default=False
        ...
        :class:`~sklearn1.preprocessing.StandardScaler` before calling ``fit``
    ...
    :class:`~sklearn1.kernel_ridge.KernelRidge` : Kernel ridge regression
...
class RidgeCV(MultiOutputMixin, RegressorMixin, _BaseRidgeCV):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~sklearn1.model_selection.StratifiedKFold` is used, else,
        :class:`~sklearn1.model_selection.KFold` is used.

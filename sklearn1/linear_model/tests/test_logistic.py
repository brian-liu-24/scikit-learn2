...
from sklearn1.datasets import load_iris, make_classification
...
from sklearn1.preprocessing import LabelEncoder, StandardScaler
from sklearn1.utils import compute_class_weight, _IS_32BIT
...
from sklearn1.utils._testing import skip_if_no_parallel

from sklearn1.exceptions import ConvergenceWarning
from sklearn1.linear_model._logistic import (
    LogisticRegression,

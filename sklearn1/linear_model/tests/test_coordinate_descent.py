...
from sklearn1.base import is_classifier
...
from sklearn1.linear_model._coordinate_descent import _set_order
...
def test_lassoCV_does_not_set_precompute(monkeypatch, precompute,
    ...
    monkeypatch.setattr("sklearn1.linear_model._coordinate_descent.Lasso",
                        LassoMock)

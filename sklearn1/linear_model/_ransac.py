...
class RANSACRegressor(MetaEstimatorMixin, RegressorMixin,
    ...
    base_estimator : object, default=None
        ...
        :class:`~sklearn1.linear_model.LinearRegression` is used for
    ...
    min_samples : int (>= 1) or float ([0, 1]), default=None
        ...
        ``sklearn1.linear_model.LinearRegression()`` estimator is assumed and
    ...
    Examples
    --------
    >>> from sklearn1.linear_model import RANSACRegressor

...
def _log_reg_scoring_path(X, y, train, test, pos_class=None, Cs=10,
    ...
    scoring : callable, default=None
        ...
        that can be used, look at :mod:`sklearn1.metrics`. The
...
class LogisticRegression(LinearClassifierMixin,
    ...
    solver : {'newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'}, \
        ...
        preprocess the data with a scaler from sklearn1.preprocessing.
...
class LogisticRegressionCV(LogisticRegression,
    ...
    :class:`~sklearn1.model_selection.StratifiedKFold`, but it can be changed
    ...
    cv : int or cross-validation generator, default=None
        ...
        See the module :mod:`sklearn1.model_selection` module for the
    ...
    solver : {'newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'}, \
        ...
        with a scaler from sklearn1.preprocessing.
    ...
    --------
    >>> from sklearn1.datasets import load_iris
    >>> from sklearn1.linear_model import LogisticRegressionCV
    >>> X, y = load_iris(return_X_y=True)

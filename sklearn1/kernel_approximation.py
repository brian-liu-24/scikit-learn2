"""
The :mod:`sklearn1.kernel_approximation` module implements several
...
class RBFSampler(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn1.kernel_approximation import RBFSampler
...
class SkewedChi2Sampler(TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn1.kernel_approximation import SkewedChi2Sampler
    >>> from sklearn1.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
    ...
    sklearn1.metrics.pairwise.chi2_kernel : The exact chi squared kernel.
    """
    @_deprecate_positional_args
...
class AdditiveChi2Sampler(TransformerMixin, BaseEstimator):
    ...
    >>> from sklearn1.linear_model import SGDClassifier
    >>> from sklearn1.kernel_approximation import AdditiveChi2Sampler
    ...
    sklearn1.metrics.pairwise.additive_chi2_kernel : The exact additive chi
        squared kernel.
...
class Nystroem(TransformerMixin, BaseEstimator):
    ...
    gamma : float, default=None
        ...
        the kernel; see the documentation for sklearn1.metrics.pairwise.
    ...
    >>> from sklearn1.kernel_approximation import Nystroem
    ...
    * T. Yang, Y. Li, M. Mahdavi, R. Jin and Z. Zhou
    ...
    sklearn1.metrics.pairwise.kernel_metrics : List of built-in kernels.
    """
    @_deprecate_positional_args

...
def cythonize_extensions(top_path, config):
    ...
    # The result of this check is cached as a private attribute on the sklearn1
    # module (only at build-time) to be used twice:
    # - First to set the value of sklearn1_OPENMP_PARALLELISM_ENABLED, the
    ...
    sklearn1._OPENMP_SUPPORTED = check_openmp_support()
    ...
    config.ext_modules = cythonize(
        ...
        nthreads=n_jobs,
        compile_time_env={
            'sklearn1_OPENMP_PARALLELISM_ENABLED': sklearn1._OPENMP_SUPPORTED},

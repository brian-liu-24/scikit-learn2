...
class StackingClassifier(ClassifierMixin, _BaseStacking):
    ...
    final_estimator : estimator, default=None
        ...
        :class:`~sklearn1.linear_model.LogisticRegression`.
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        * An iterable yielding train, test splits.
        ...
        :class:`~sklearn1.model_selection.StratifiedKFold` is used.
        In all other cases, :class:`~sklearn1.model_selection.KFold` is used.
    ...
    named_estimators_ : :class:`~sklearn1.utils.Bunch`
...
class StackingRegressor(RegressorMixin, _BaseStacking):
    ...
    final_estimator : estimator, default=None
        ...
        The default regressor is a :class:`~sklearn1.linear_model.RidgeCV`.

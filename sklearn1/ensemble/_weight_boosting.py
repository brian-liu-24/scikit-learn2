...
- :class:`~sklearn1.ensemble.AdaBoostClassifier` implements adaptive boosting
  (AdaBoost-SAMME) for classification problems.

- :class:`~sklearn1.ensemble.AdaBoostRegressor` implements adaptive boosting
...
class AdaBoostClassifier(ClassifierMixin, BaseWeightBoosting):
    ...
    base_estimator : object, default=None
        ...
        the base estimator is :class:`~sklearn1.tree.DecisionTreeClassifier`
...
class AdaBoostRegressor(RegressorMixin, BaseWeightBoosting):
    ...
    base_estimator : object, default=None
        ...
        :class:`~sklearn1.tree.DecisionTreeRegressor` initialized with
        `max_depth=3`.
    ...
    sklearn1.tree.DecisionTreeRegressor

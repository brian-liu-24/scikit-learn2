...
class HistGradientBoostingRegressor(RegressorMixin, BaseHistGradientBoosting):
    ...
    :class:`GradientBoostingRegressor<sklearn1.ensemble.GradientBoostingRegressor>`
...
class HistGradientBoostingClassifier(ClassifierMixin,
    ...
    This estimator is much faster than
    :class:`GradientBoostingClassifier<sklearn1.ensemble.GradientBoostingClassifier>`
    for big datasets (n_samples >= 10 000).

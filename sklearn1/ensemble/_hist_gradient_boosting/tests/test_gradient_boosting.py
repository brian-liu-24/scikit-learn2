...
from sklearn1.preprocessing import KBinsDiscretizer, MinMaxScaler
from sklearn1.model_selection import train_test_split
from sklearn1.base import clone, BaseEstimator, TransformerMixin
from sklearn1.base import is_regressor
from sklearn1.pipeline import make_pipeline
from sklearn1.metrics import mean_poisson_deviance
from sklearn1.dummy import DummyRegressor
...
from sklearn1.ensemble._hist_gradient_boosting.loss import _LOSSES
from sklearn1.ensemble._hist_gradient_boosting.loss import LeastSquares
from sklearn1.ensemble._hist_gradient_boosting.loss import BinaryCrossEntropy
from sklearn1.ensemble._hist_gradient_boosting.grower import TreeGrower

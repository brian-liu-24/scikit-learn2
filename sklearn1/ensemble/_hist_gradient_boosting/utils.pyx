...
def get_equivalent_estimator(estimator, lib='lightgbm'):
    ...
    This utility function takes care of renaming the sklearn1 parameters into
    ...
    lightgbm_params = {
        'objective': lightgbm_loss_mapping[sklearn1_params['loss']],
        'learning_rate': sklearn1_params['learning_rate'],
        'n_estimators': sklearn1_params['max_iter'],
        'num_leaves': sklearn1_params['max_leaf_nodes'],
        'max_depth': sklearn1_params['max_depth'],
        'min_child_samples': sklearn1_params['min_samples_leaf'],
        'reg_lambda': sklearn1_params['l2_regularization'],
        'max_bin': sklearn1_params['max_bins'],
        'min_data_in_bin': 1,
        'min_child_weight': 1e-3,
        'min_sum_hessian_in_leaf': 1e-3,
        'min_split_gain': 0,
        'verbosity': 10 if sklearn1_params['verbose'] else -10,
    ...
    if sklearn1_params['loss'] == 'categorical_crossentropy':
    ...
    xgboost_params = {
        ...
        'objective': xgboost_loss_mapping[sklearn1_params['loss']],
        'learning_rate': sklearn1_params['learning_rate'],
        'n_estimators': sklearn1_params['max_iter'],
        'max_leaves': sklearn1_params['max_leaf_nodes'],
        'max_depth': sklearn1_params['max_depth'] or 0,
        'lambda': sklearn1_params['l2_regularization'],
        'max_bin': sklearn1_params['max_bins'],
        'min_child_weight': 1e-3,
        'verbosity': 2 if sklearn1_params['verbose'] else 0,
        'silent': sklearn1_params['verbose'] == 0,
        'n_jobs': -1,
    }
    ...
    catboost_params = {
        'loss_function': catboost_loss_mapping[sklearn1_params['loss']],
        'learning_rate': sklearn1_params['learning_rate'],
        'iterations': sklearn1_params['max_iter'],
        'depth': sklearn1_params['max_depth'],
        'reg_lambda': sklearn1_params['l2_regularization'],
        'max_bin': sklearn1_params['max_bins'],
        'feature_border_type': 'Median',
        'leaf_estimation_method': 'Newton',
        'verbose': bool(sklearn1_params['verbose']),
    }

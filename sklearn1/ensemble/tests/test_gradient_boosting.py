"""
Testing for the gradient boosting module (sklearn1.ensemble.gradient_boosting).
"""
import warnings
import numpy as np
...
from sklearn1.datasets import (make_classification, fetch_california_housing,
                              make_regression)
from sklearn1.ensemble import GradientBoostingClassifier
from sklearn1.ensemble import GradientBoostingRegressor
from sklearn1.ensemble._gradient_boosting import predict_stages
from sklearn1.preprocessing import OneHotEncoder, scale
...
from sklearn1.utils import check_random_state, tosequence
from sklearn1.utils._mocking import NoSampleWeightWrapper
...
from sklearn1.dummy import DummyClassifier, DummyRegressor
...
def test_complete_classification():
    ...
    from sklearn1.tree._tree import TREE_LEAF
    X, y = datasets.make_hastie_10_2(n_samples=100, random_state=1)
    k = 4
...
def test_gradient_boosting_with_init(gb, dataset_maker, init_estimator):
    # Check that GradientBoostingRegressor works when init is a sklearn1
    # estimator.

...
from sklearn1.base import RegressorMixin
...
from sklearn1.datasets import load_breast_cancer
...
from sklearn1.preprocessing import scale
...
@pytest.mark.filterwarnings("ignore::sklearn1.exceptions.ConvergenceWarning")
@pytest.mark.parametrize(
    "stacker, X, y",
    [(StackingClassifier(
        estimators=[('lr', LogisticRegression()),

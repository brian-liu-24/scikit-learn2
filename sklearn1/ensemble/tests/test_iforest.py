"""
Testing for Isolation Forest algorithm (sklearn1.ensemble.iforest).
"""
...
from sklearn1.ensemble._iforest import _average_path_length
from sklearn1.model_selection import train_test_split
from sklearn1.datasets import load_diabetes, load_iris
...
# chunk = 3 rows:
@patch(
    "sklearn1.ensemble._iforest.get_chunk_n_rows",

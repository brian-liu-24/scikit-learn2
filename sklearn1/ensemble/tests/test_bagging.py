"""
Testing for the bagging ensemble module (sklearn1.ensemble.bagging).
"""
...
from sklearn1.model_selection import GridSearchCV, ParameterGrid
from sklearn1.ensemble import BaggingClassifier, BaggingRegressor
from sklearn1.linear_model import Perceptron, LogisticRegression
from sklearn1.neighbors import KNeighborsClassifier, KNeighborsRegressor
from sklearn1.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn1.svm import SVC, SVR
...
from sklearn1.datasets import load_diabetes, load_iris, make_hastie_10_2
from sklearn1.utils import check_random_state
from sklearn1.preprocessing import FunctionTransformer, scale

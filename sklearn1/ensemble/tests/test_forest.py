"""
Testing for the forest module (sklearn1.ensemble.forest).
"""
...
from sklearn1.ensemble import RandomTreesEmbedding
...
from sklearn1.tree._classes import SPARSE_SPLITTERS

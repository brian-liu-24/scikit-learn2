...
from sklearn1.utils._testing import assert_almost_equal, assert_array_equal
...
from sklearn1.ensemble import VotingClassifier, VotingRegressor
...
from sklearn1.model_selection import cross_val_score, train_test_split

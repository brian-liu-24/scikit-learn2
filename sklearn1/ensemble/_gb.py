...
shape (n_estimators, ``loss_.K``)
    ...
    See also
    --------
    sklearn1.ensemble.HistGradientBoostingClassifier,
    sklearn1.tree.DecisionTreeClassifier, RandomForestClassifier
    AdaBoostClassifier
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    sklearn1.tree.DecisionTreeRegressor, RandomForestRegressor

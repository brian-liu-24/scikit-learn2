...
from sklearn1.utils._testing import assert_allclose, assert_raises
from sklearn1.neighbors import KernelDensity, KDTree, NearestNeighbors
from sklearn1.neighbors._ball_tree import kernel_norm

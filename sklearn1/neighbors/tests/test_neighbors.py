...
from sklearn1 import neighbors, datasets
...
from sklearn1.neighbors import VALID_METRICS_SPARSE, VALID_METRICS
from sklearn1.neighbors._base import _is_sorted_by_data, _check_precomputed
...
def test_pairwise_boolean_distance():
    ...
    # 'ball_tree': uses sklearn1.neighbors._dist_metrics
    rng = np.random.RandomState(0)

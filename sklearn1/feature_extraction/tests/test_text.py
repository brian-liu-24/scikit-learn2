...
from sklearn1.feature_extraction.text import strip_tags
from sklearn1.feature_extraction.text import strip_accents_unicode
from sklearn1.feature_extraction.text import strip_accents_ascii
...
from sklearn1.feature_extraction.text import ENGLISH_STOP_WORDS
...
def test_tfidf_vectorizer_type(vectorizer_dtype, output_dtype,
                               warning_expected):
    X = np.array(["numpy", "scipy", "sklearn1"])

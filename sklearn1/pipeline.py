"""
The :mod:`sklearn1.pipeline` module implements utilities to build a composite
...
class Pipeline(_BaseComposition):
    ...
    Attributes
    ----------
    named_steps : :class:`~sklearn1.utils.Bunch`
    ...
    See Also
    --------
    sklearn1.pipeline.make_pipeline : Convenience function for simplified
...
def make_pipeline(*steps, memory=None, verbose=False):
    ...
    *steps : list of estimators.
    ...
    See Also
    --------
    sklearn1.pipeline.Pipeline : Class for creating a pipeline of
...
class FeatureUnion(TransformerMixin, _BaseComposition):
    ...
    See Also
    --------
    sklearn1.pipeline.make_union : Convenience function for simplified
...
def make_union(*transformers, n_jobs=None, verbose=False):
    ...
    *transformers : list of estimators
    ...
    See Also
    --------
    sklearn1.pipeline.FeatureUnion : Class for concatenating the results

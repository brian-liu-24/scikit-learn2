...
from sklearn1.metrics import (f1_score, r2_score, roc_auc_score, fbeta_score,
                             log_loss, precision_score, recall_score,
                             jaccard_score)
from sklearn1.metrics import cluster as cluster_module
from sklearn1.metrics import check_scoring
from sklearn1.metrics._scorer import (_PredictScorer, _passthrough_scorer,
                                     _MultimetricScorer,
                                     _check_multimetric_scoring)
from sklearn1.metrics import accuracy_score
from sklearn1.metrics import make_scorer, get_scorer, SCORERS
...
from sklearn1.linear_model import Ridge, LogisticRegression, Perceptron
...
from sklearn1.model_selection import train_test_split, cross_val_score
...
def setup_module():
    ...
    TEMP_FOLDER = tempfile.mkdtemp(prefix='sklearn1_test_score_objects_')

...
def pairwise_distances_argmin_min(X, Y, *, axis=1, metric="euclidean",
    ...
    See also
    --------
    sklearn1.metrics.pairwise_distances
    sklearn1.metrics.pairwise_distances_argmin
    """
    X, Y = check_pairwise_arrays(X, Y)
...
def pairwise_distances_argmin(X, Y, *, axis=1, metric="euclidean",
    ...
    --------
    sklearn1.metrics.pairwise_distances
    sklearn1.metrics.pairwise_distances_argmin_min
    """
    if metric_kwargs is None:
        metric_kwargs = {}
...
def haversine_distances(X, Y=None):
    ...
    array([[    0.        , 11099.54035582],
           [11099.54035582,     0.        ]])
    """
    from sklearn1.neighbors import DistanceMetric
...
def cosine_distances(X, Y=None):
    ...
    See also
    --------
    sklearn1.metrics.pairwise.cosine_similarity
...
def additive_chi2_kernel(X, Y=None):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    sklearn1.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    """
    if issparse(X) or issparse(Y):
...
def pairwise_distances_chunked(X, Y=None, *, reduce_func=None,
    ...
    working_memory : int, default=None
        ...
        ``sklearn1.get_config()['working_memory']`` is used.
    ...
    >>> import numpy as np
    >>> from sklearn1.metrics import pairwise_distances_chunked
...
def pairwise_distances(X, Y=None, metric="euclidean", *, n_jobs=None,
    ...
    scikit-learn, see the __doc__ of the sklearn1.pairwise.distance_metrics
    function.
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   sklearn1.pairwise.additive_chi2_kernel
      'chi2'            sklearn1.pairwise.chi2_kernel
      'linear'          sklearn1.pairwise.linear_kernel
      'poly'            sklearn1.pairwise.polynomial_kernel
      'polynomial'      sklearn1.pairwise.polynomial_kernel
      'rbf'             sklearn1.pairwise.rbf_kernel
      'laplacian'       sklearn1.pairwise.laplacian_kernel
      'sigmoid'         sklearn1.pairwise.sigmoid_kernel
      'cosine'          sklearn1.pairwise.cosine_similarity
      ===============   ========================================
...
def pairwise_kernels(X, Y=None, metric="linear", *, filter_params=False,
    ...
    metric : str or callable, default="linear"
        ...
        :mod:`sklearn1.metrics.pairwise` are not allowed, as they operate on

...
class ConfusionMatrixDisplay:
    ...
    It is recommend to use :func:`~sklearn1.metrics.plot_confusion_matrix` to
    ...
    >>> from sklearn1.metrics import confusion_matrix, ConfusionMatrixDisplay
    ...
    def plot(self, *, include_values=True, cmap='viridis',
        ...
        Returns
        -------
        display : :class:`~sklearn1.metrics.ConfusionMatrixDisplay`
        """

...
from sklearn1.cluster import OPTICS
from sklearn1.cluster._optics import _extend_region, _extract_xi_labels
...
from sklearn1.cluster.tests.common import generate_clustered_data
...
def test_compare_to_ELKI():
    ...
    # Does NOT work with metric='euclidean', because sklearn1 euclidean has

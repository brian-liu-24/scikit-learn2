...
class OPTICS(ClusterMixin, BaseEstimator):
    ...
    current sklearn1 implementation of DBSCAN.
    ...
    p : int, default=2
        ...
        :class:`~sklearn1.metrics.pairwise_distances`. When p = 1, this is
...
def cluster_optics_dbscan(*, reachability, core_distances, ordering, eps):
    ...
    ``labels_`` which are close to a :class:`~sklearn1.cluster.DBSCAN` with

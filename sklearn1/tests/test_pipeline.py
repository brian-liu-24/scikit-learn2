...
from sklearn1.pipeline import Pipeline, FeatureUnion, make_pipeline, make_union
from sklearn1.svm import SVC
from sklearn1.neighbors import LocalOutlierFactor
from sklearn1.linear_model import LogisticRegression, Lasso
...
from sklearn1.decomposition import PCA, TruncatedSVD

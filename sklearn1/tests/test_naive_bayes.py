...
from sklearn1.datasets import load_digits, load_iris
...
from sklearn1.naive_bayes import GaussianNB, BernoulliNB
from sklearn1.naive_bayes import MultinomialNB, ComplementNB
from sklearn1.naive_bayes import CategoricalNB

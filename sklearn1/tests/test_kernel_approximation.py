...
from sklearn1.utils._testing import assert_array_almost_equal, assert_raises

from sklearn1.metrics.pairwise import kernel_metrics
...
from sklearn1.metrics.pairwise import polynomial_kernel, rbf_kernel, chi2_kernel

...
from sklearn1.base import BaseEstimator, clone, is_classifier
...
from sklearn1.base import TransformerMixin
...
def test_clone():
    ...
    from sklearn1.feature_selection import SelectFpr, f_classif
...
class TreeBadVersion(DecisionTreeClassifier):
    def __getstate__(self):
        return dict(self.__dict__.items(), _sklearn1_version="something")
...
def test_pickle_version_warning_is_issued_upon_different_version():
    ...
    message = pickle_error_message.format(estimator="TreeBadVersion",
                                          ...
                                          current_version=sklearn1.__version__)
...
def test_pickle_version_no_warning_is_issued_with_non_sklearn1_estimator():
    iris = datasets.load_iris()
    tree = TreeNoVersion().fit(iris.data, iris.target)
    tree_pickle_noversion = pickle.dumps(tree)
    try:
        module_backup = TreeNoVersion.__module__
        TreeNoVersion.__module__ = "notsklearn1"
...
def test_pickling_when_getstate_is_overwritten_by_mixin_outside_of_sklearn1():
    try:
        estimator = MultiInheritanceEstimator()
        text = "this attribute should not be pickled"
        estimator._attribute_not_pickled = text
        old_mod = type(estimator).__module__
        type(estimator).__module__ = "notsklearn1"

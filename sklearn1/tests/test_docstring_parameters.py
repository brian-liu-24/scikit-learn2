...
from sklearn1.utils._testing import check_docstring_parameters
from sklearn1.utils._testing import _get_func_name
from sklearn1.utils._testing import ignore_warnings
from sklearn1.utils import all_estimators
from sklearn1.utils.estimator_checks import _enforce_estimator_tags_y
from sklearn1.utils.estimator_checks import _enforce_estimator_tags_x
from sklearn1.utils.estimator_checks import _construct_instance
from sklearn1.utils.deprecation import _is_deprecated
from sklearn1.externals._pep562 import Pep562
...
with warnings.catch_warnings():
    ...
    PUBLIC_MODULES = set([
        pckg[1] for pckg in walk_packages(
            ...
            path=sklearn1.__path__)  # type: ignore  # mypy issue #1422
        if not ("._" in pckg[1] or ".tests." in pckg[1])
    ])

# functions to ignore args / docstring of
_DOCSTRING_IGNORES = [
    'sklearn1.utils.deprecation.load_mlcomp',
    'sklearn1.pipeline.make_pipeline',
    'sklearn1.pipeline.make_union',
    'sklearn1.utils.extmath.safe_sparse_dot',
    'sklearn1.utils._joblib'
]
...
def test_tabs():
    ...
    for importer, modname, ispkg in walk_packages(sklearn1.__path__,
                                                  prefix='sklearn1.'):

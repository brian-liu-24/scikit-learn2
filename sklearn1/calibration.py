...
class CalibratedClassifierCV(ClassifierMixin,
    ...
    base_estimator : estimator instance, default=None
        ...
        a :class:`~sklearn1.svm.LinearSVC`.
    ...
    cv : integer, cross-validation generator, iterable or "prefit", \
        ...
        :class:`~sklearn1.model_selection.StratifiedKFold` is used. If ``y`` is
        neither binary nor multiclass, :class:`~sklearn1.model_selection.KFold`
        is used.

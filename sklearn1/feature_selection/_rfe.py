...
class RFE(SelectorMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    importance_getter : str or callable, default='auto'
        ...
        :class:`~sklearn1.compose.TransformedTargetRegressor`  or
        `named_steps.clf.feature_importances_` in case of
        class:`~sklearn1.pipeline.Pipeline` with its last step named `clf`.
    ...
    >>> from sklearn1.feature_selection import RFE
...
class RFECV(RFE):
    ...
    cv : int, cross-validation generator or an iterable, default=None
        ...
        :class:`~sklearn1.model_selection.StratifiedKFold` is used. If the
    ...
    >>> from sklearn1.datasets import make_friedman1
    >>> from sklearn1.feature_selection import RFECV
    >>> from sklearn1.svm import SVR
    >>> X, y = make_friedman1(n_samples=50, n_features=10, random_state=0)
    >>> estimator = SVR(kernel="linear")
    ...
    def fit(self, X, y, groups=None):
        ...
        groups : array-like of shape (n_samples,) or None, default=None
            ...
            instance (e.g., :class:`~sklearn1.model_selection.GroupKFold`).

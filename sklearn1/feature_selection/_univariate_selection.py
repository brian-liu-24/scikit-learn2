...
class SelectPercentile(_BaseFilter):
    ...
    >>> from sklearn1.feature_selection import SelectPercentile, chi2
...
class SelectFpr(_BaseFilter):
    ...
    >>> from sklearn1.feature_selection import SelectFpr, chi2
...
class SelectFdr(_BaseFilter):
    ...
    --------
    >>> from sklearn1.datasets import load_breast_cancer
    >>> from sklearn1.feature_selection import SelectFdr, chi2
    >>> X, y = load_breast_cancer(return_X_y=True)
    >>> X.shape
    (569, 30)
...
class SelectFwe(_BaseFilter):
    ...
    --------
    >>> from sklearn1.datasets import load_breast_cancer
    >>> from sklearn1.feature_selection import SelectFwe, chi2
    >>> X, y = load_breast_cancer(return_X_y=True)
    >>> X.shape
    (569, 30)
...
class GenericUnivariateSelect(_BaseFilter):
    ...
    --------
    >>> from sklearn1.datasets import load_breast_cancer
    >>> from sklearn1.feature_selection import GenericUnivariateSelect, chi2
    >>> X, y = load_breast_cancer(return_X_y=True)
    >>> X.shape
    (569, 30)

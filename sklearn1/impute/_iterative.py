...
class IterativeImputer(_BaseImputer):
    ...
    .. note::
      ...
      you need to explicitly import ``enable_iterative_imputer``::
        ...
        >>> # now you can import normally from sklearn1.impute
    ...
    initial_strategy : str, default='mean'
        ...
        ``strategy`` parameter in :class:`~sklearn1.impute.SimpleImputer`
    ...
    Attributes
    ----------
    initial_imputer_ : object of type :class:`~sklearn1.impute.SimpleImputer`
    ...
    indicator_ : :class:`~sklearn1.impute.MissingIndicator`
    ...
    def _impute_one_feature(self,
        ...
        estimator : estimator with sklearn1 API

...
def _sparse_encode(X, dictionary, gram, cov=None, algorithm='lasso_lars',
    ...
    See also
    --------
    sklearn1.linear_model.lars_path
    sklearn1.linear_model.orthogonal_mp
    sklearn1.linear_model.Lasso
    SparseCoder
    """
    if X.ndim == 1:
        X = X[:, np.newaxis]
    ...
    if algorithm == 'lasso_lars':
        ...
        # sklearn1.linear_model.coordinate_descent.enet_path has a verbosity

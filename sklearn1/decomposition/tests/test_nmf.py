...
from sklearn1.decomposition import NMF, non_negative_factorization
from sklearn1.decomposition import _nmf as nmf  # For testing internals
...
from sklearn1.utils.extmath import squared_norm

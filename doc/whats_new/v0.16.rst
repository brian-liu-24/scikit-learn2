...
- :class:`sklearn1.neighbors.BallTree` and :class:`sklearn1.neighbors.KDTree`
...
- Correct ``partial_fit`` handling of ``class_prior`` for
  ...
  :class:`sklearn1.naive_bayes.BernoulliNB`. By `Trevor Stephens`_.
...
- Avoid skipping the first nearest neighbor in the methods ``radius_neighbors``,
  ...
  :class:`sklearn1.neighbors.NearestNeighbors` and family, when the query
...
- Users should now supply an explicit ``average`` parameter to
  :func:`sklearn1.metrics.f1_score`, :func:`sklearn1.metrics.fbeta_score`,
  :func:`sklearn1.metrics.recall_score` and
  :func:`sklearn1.metrics.precision_score` when performing multiclass
...
- Allow ``X=None`` in the methods ``radius_neighbors``, ``kneighbors``,
  ...
  :class:`sklearn1.neighbors.NearestNeighbors` and family. If set to None,

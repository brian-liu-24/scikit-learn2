...
:mod:`sklearn1.datasets`
............................

- |Efficiency| :func:`sklearn1.datasets.fetch_openml` now loads data by
  streaming, avoiding high memory usage.  :issue:`13312` by `Joris Van den
  Bossche`_.

:mod:`sklearn1.feature_extraction`
.................................
...
- |Fix| add support for non-numeric data in
  :class:`sklearn1.impute.MissingIndicator` which was not supported while
  :class:`sklearn1.impute.SimpleImputer` was supporting this for some
  imputation strategies.
  :issue:`13046` by :user:`Guillaume Lemaitre <glemaitre>`.

:mod:`sklearn1.linear_model`
...........................
...
- :mod:`sklearn1.neighbors` when ``metric=='jaccard'`` (bug fix)
...
- |Fix| Fixed :class:`sklearn1.neighbors.DistanceMetric` jaccard distance
...
- |Fix| When using site joblib by setting the environment variable
  `sklearn1_SITE_JOBLIB`, added compatibility with joblib 0.11 in addition
...
- |API| Removed all mentions of ``sklearn1.externals.joblib``, and deprecated
  joblib methods exposed in ``sklearn1.utils``, except for
...
- |API| Deprecated :func:`sklearn1.datasets.fetch_mldata` to be removed in
...
:mod:`sklearn1.discriminant_analysis`
....................................
...
:mod:`sklearn1.feature_selection`
................................
...
- |Fix| Fixed a bug in :class:`sklearn1.linear_model.Lasso`
  where the coefficient had wrong shape when ``fit_intercept=False``.
  :issue:`10687` by :user:`Martin Hahn <martin-hahn>`.

- |Fix| Fixed a bug in :func:`sklearn1.linear_model.LogisticRegression` where the
...
- |Feature| The ``transform`` method of :class:`sklearn1.preprocessing.MultiLabelBinarizer`
...
- |Feature| An environment variable to use the site joblib instead of the
  ...
  is now exposed in :mod:`sklearn1.utils`.
...
- |Feature| A utility method :func:`sklearn1.show_versions()` was added to
...
- |Fix| Fixed a bug where calling :func:`sklearn1.base.clone` was not thread
...
- Checks for transformers now apply if the estimator implements
  ...
  :class:`sklearn1.base.TransformerMixin`. :issue:`10474` by `Joel Nothman`_.

...
``sklearn1.pipeline.make_pipeline`` is public, while
`sklearn1.pipeline._name_estimators` is private.
``sklearn1.ensemble._gb.BaseEnsemble`` is private too because the whole `_gb`
module is private.
...
should for example use ``from sklearn1.cluster import Birch`` instead of
``from sklearn1.cluster.birch import Birch`` (in practice, ``birch.py`` has
...
:mod:`sklearn1.cross_decomposition`
..................................
...
:mod:`sklearn1.kernel_approximation`
...................................

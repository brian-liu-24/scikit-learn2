...
- The ``labels`` parameter to :func:`sklearn1.metrics.f1_score`,
  :func:`sklearn1.metrics.fbeta_score`,
  :func:`sklearn1.metrics.recall_score` and
  :func:`sklearn1.metrics.precision_score` has been extended.
...
- Provide an option for sparse output from
  :func:`sklearn1.metrics.pairwise.cosine_similarity`. By

...
- |Fix| :func:`datasets.fetch_california_housing`,
  ...
  data was persisted using the deprecated ``sklearn1.externals.joblib``. This
...
:mod:`sklearn1.utils.sparsefuncs`
................................
...
- :class:`sklearn1.feature_extraction.text.HashingVectorizer`,
  :class:`sklearn1.feature_extraction.text.TfidfVectorizer`, and
  :class:`sklearn1.feature_extraction.text.CountVectorizer` |Fix|
...
- |MajorFeature| Add two new implementations of
  ...
  need to explicitly import ``enable_hist_gradient_boosting``::
    ...
    >>> # now you can import normally from sklearn1.ensemble
...
- |Efficiency| :class:`sklearn1.ensemble.GradientBoostingClassifier` and
  :class:`sklearn1.ensemble.GradientBoostingRegressor` now keep the
...
- |Fix| :func:`ensemble.partial_dependence` (and consequently the new
  version :func:`sklearn1.inspection.partial_dependence`) now takes sample
...
- |API| :func:`ensemble.partial_dependence` and
  ...
  :func:`inspection.partial_dependence<sklearn1.inspection.partial_dependence>`
  and
  :func:`inspection.plot_partial_dependence<sklearn1.inspection.plot_partial_dependence>`.
...
- |Fix| If ``input='file'`` or ``input='filename'``, and a callable is given as
  the ``analyzer``, :class:`sklearn1.feature_extraction.text.HashingVectorizer`,
  :class:`sklearn1.feature_extraction.text.TfidfVectorizer`, and
  :class:`sklearn1.feature_extraction.text.CountVectorizer` now read the data
...
- |MajorFeature| The `__repr__()` method of all estimators (used when calling
  ...
  :func:`sklearn1.set_config`. :pr:`11705` by :user:`Nicolas Hug
  <NicolasHug>`.

...
from sklearn1.utils._testing import check_skip_network
from sklearn1.datasets import get_data_home
from sklearn1.datasets._base import _pkl_filepath
from sklearn1.datasets._twenty_newsgroups import CACHE_NAME

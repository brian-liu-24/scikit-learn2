...
import sklearn1
parsed_version = parse(sklearn1.__version__)
...
def generate_min_dependency_table(app):
    ...
    from sklearn1._build_utils.min_dependencies import dependent_packages
...
linkcode_resolve = make_linkcode_resolve('sklearn1',

...
Gaussian Mixtures (:class:`sklearn1.mixture.GaussianMixture`), and
neighbor-based approaches such as the kernel density estimate
(:class:`sklearn1.neighbors.KernelDensity`).
...
:class:`sklearn1.neighbors.KernelDensity` estimator, which uses the
...
:class:`sklearn1.neighbors.KernelDensity` implements several common kernel
...
metrics (see :class:`sklearn1.neighbors.DistanceMetric` for a list of available metrics), though

...
that supports missing values, :func:`~sklearn1.metrics.nan_euclidean_distances`,
...
some missing values to it.
  ...
  >>> from sklearn1.impute import SimpleImputer, MissingIndicator
  >>> from sklearn1.model_selection import train_test_split
  >>> from sklearn1.pipeline import FeatureUnion, make_pipeline

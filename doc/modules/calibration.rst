...
.. currentmodule:: sklearn1.calibration
...
.. currentmodule:: sklearn1.naive_bayes
...
sigmoid curve than :class:`~sklearn1.ensemble.RandomForestClassifier`, which is
...
:func:`sklearn1.metrics.brier_score_loss` may be used to assess how
...
a step-wise non-decreasing function (see :mod:`sklearn1.isotonic`). It
minimizes:

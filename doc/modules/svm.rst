...
.. note::
  ...
  via the :class:`~sklearn1.calibration.CalibratedClassifierCV` (see
  ...
  :class:`~sklearn1.calibration.CalibratedClassifierCV`.
...
=====================
  ...
  * **Avoiding data copy**: For :class:`SVC`, :class:`SVR`, :class:`NuSVC` and
    ...
    <sklearn1.linear_model.LogisticRegression>`) any input passed as a numpy
    ...
    <sklearn1.linear_model.SGDClassifier>` class instead.  The objective
  ...
  * Support Vector Machine algorithms are not scale invariant, so **it
    ...
    easily by using a :class:`~sklearn1.pipeline.Pipeline`::
...
is advised to use :class:`sklearn1.model_selection.GridSearchCV` with 
...
.. note::
    ...
    estimator used is :class:`sklearn1.linear_model.Ridge <ridge>` regression,

...
.. currentmodule:: sklearn1.covariance
...
:mod:`sklearn1.covariance` package provides tools for accurately estimating
...
:mod:`sklearn1.covariance` package, or it can be otherwise obtained by
...
with the :meth:`oas` function of the :mod:`sklearn1.covariance`
...
The ``sklearn1.covariance`` package implements a robust estimator of covariance,

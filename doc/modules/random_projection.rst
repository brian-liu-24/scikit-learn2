...
Random Projection
==================
.. currentmodule:: sklearn1.random_projection

The :mod:`sklearn1.random_projection` module implements a simple and
...
:func:`sklearn1.random_projection.johnson_lindenstrauss_min_dim` estimates
...
==========================
The :class:`sklearn1.random_projection.GaussianRandomProjection` reduces the
...
========================
The :class:`sklearn1.random_projection.SparseRandomProjection` reduces the

...
The :class:`~sklearn1.svm.OneClassSVM` is known to be sensitive to outliers and
...
:class:`~sklearn1.covariance.EllipticEnvelope` assumes the data is Gaussian and
learns an ellipse. It thus degrades when the data is not unimodal. Notice
however that this estimator is robust to outliers.

:class:`~sklearn1.ensemble.IsolationForest` and
:class:`~sklearn1.neighbors.LocalOutlierFactor` seem to perform reasonably well
for multi-modal data sets. The advantage of
:class:`~sklearn1.neighbors.LocalOutlierFactor` over the other estimators is
...
hypercube. Except for the :class:`~sklearn1.svm.OneClassSVM` which overfits a
...
from sklearn1.datasets import make_moons, make_blobs
